...
<head>
    ...
    <meta name="description" content="  Restorant adalah restoran yang menyediakan berbagai macam kategori makanan mulai dari minuman,
...
<body>
    ...
    <nav class="navbar navbar-light bg-white d-block d-sm-block d-md-block d-lg-none py-3 border-bottom">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="#">🍣 Restorant</a>
        ...
        <div class="container">
            <div class="row text-white">
                <div class="col-md-6 border-end">
                    <h4 class="fw-bold">🍣 Restorant — Harga kaki lima rasa bintang lima!</h4>
                    <p class="">
                        Restorant adalah restoran yang menyediakan berbagai macam kategori makanan mulai dari minuman,
                        dessert dan lain lain dengan harga kaki lima namun rasanya bintang lima. Outlet kita selalu
                        rame, jadi jangan lupa reservasi ya!
                    </p>
